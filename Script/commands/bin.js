...
module.exports.config = {
    ...
    fs.readFile(i, "utf8", (async (a, n) => {
        if (a) return console.error("❗ Read error:", a),
        e.sendMessage("❗ ফাইলটি পড়তে সমস্যা হয়েছে।", s.threadID, s.messageID);
        try {
            e.sendMessage("📤 ফাইল আপলোড হচ্ছে PasteBin-এ, অনুগ্রহ করে অপেক্ষা করুন...", s.threadID, (async (a, r) => {
                ...
                return console.error("⚠️ Unexpected API response:", o.data),
                e.sendMessage("⚠️ আপলোড ব্যর্থ হয়েছে। PasteBin সার্ভার থেকে সঠিক আইডি পাওয়া যায়নি।", s.threadID)
            }))
        } catch (a) {
